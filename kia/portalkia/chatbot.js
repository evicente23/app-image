...
var initESW = function(gslbBaseURL) {
  ...
  embedded_svc.settings.storageDomain = 'www.inpsercom.com'; //(Sets the domain for your deployment so that visitors can navigate subdomains during a chat session)
